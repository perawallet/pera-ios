...
//   CreateJointAccountNameAccountView.swift

import SwiftUI

struct CreateJointAccountNameAccountView: View {
    ...
    var body: some View {
        VStack {
            OnboardingTitleView(title: "create-joint-account-name-account-title", description: "create-joint-account-name-account-description")
                .padding(.bottom, 32.0)
