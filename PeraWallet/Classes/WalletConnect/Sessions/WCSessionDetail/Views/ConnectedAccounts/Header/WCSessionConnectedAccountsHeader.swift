...
//   WCSessionConnectedAccountsHeader.swift

import UIKit
import MacaroonUIKit

final class WCSessionConnectedAccountsHeader:
    ...
    static let theme = WCSessionConnectedAccountsHeaderTheme()
    ...
    func bindData(_ viewModel: WCSessionConnectedAccountsHeaderViewModel?) {
    ...
    public static func calculatePreferredSize(
        _ viewModel: WCSessionConnectedAccountsHeaderViewModel?,
