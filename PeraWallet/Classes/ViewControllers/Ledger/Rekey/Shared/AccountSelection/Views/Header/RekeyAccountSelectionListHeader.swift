...
//   RekeyAccountSelectionListHeader.swift

import UIKit
import MacaroonUIKit

final class RekeyAccountSelectionListHeader:
    ...
    static let theme = RekeyAccountSelectionListHeaderTheme()
    ...
    func bindData(_ viewModel: RekeyAccountSelectionListHeaderViewModel?) {
    ...
    public static func calculatePreferredSize(
        _ viewModel: RekeyAccountSelectionListHeaderViewModel?,
