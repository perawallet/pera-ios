...
//   MoonPayAccountSelectionListHeader.swift

import UIKit
import MacaroonUIKit

final class MoonPayAccountSelectionListHeader:
    ...
    static let theme = MoonPayAccountSelectionListHeaderTheme()
    ...
    func bindData(_ viewModel: MoonPayAccountSelectionListHeaderViewModel?) {
    ...
    public static func calculatePreferredSize(
        _ viewModel: MoonPayAccountSelectionListHeaderViewModel?,
