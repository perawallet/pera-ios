...
//   BidaliAccountSelectionListHeader.swift

import UIKit
import MacaroonUIKit

final class BidaliAccountSelectionListHeader:
    ...
    static let theme = BidaliAccountSelectionListHeaderTheme()
    ...
    func bindData(_ viewModel: BidaliAccountSelectionListHeaderViewModel?) {
    ...
    public static func calculatePreferredSize(
        _ viewModel: BidaliAccountSelectionListHeaderViewModel?,
