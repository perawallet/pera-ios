...
//   BidaliAccountSelectionListDataSource.swift

import Foundation
import UIKit

final class BidaliAccountSelectionListDataSource: AccountSelectionListDataSource {
    ...
    init(_ itemDataSource: BidaliAccountSelectionListItemDataSource) {
    ...
    var supportedCells: [UICollectionViewCell.Type] = [
        ...
        BidaliAccountSelectionListAccountListItemCell.self
    ]
    ...
    var supportedSupplementaryViews: [UICollectionReusableView.Type] = [
        BidaliAccountSelectionListHeader.self
    ]
