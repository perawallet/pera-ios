...
final class AccountChartsCell: UICollectionViewCell {
    ...
    static let theme = AccountChartsViewTheme()
    ...
    private func addChartView(_ theme: AccountChartsViewTheme) {
        ...
        hostingController.view.snp.makeConstraints {
            ...
            $0.bottom.equalToSuperview().inset(theme.chartViewBottomInset)
            $0.height.equalTo(theme.contentHeight)
        }
    }
