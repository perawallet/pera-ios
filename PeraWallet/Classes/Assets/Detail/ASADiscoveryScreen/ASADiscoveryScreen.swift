...
final class ASADiscoveryScreen:
    ...
    private lazy var profileView = ASAProfileView(type: .assetDescovery, showNotificationAndFavoriteButtons: configuration.featureFlagService.isEnabled(.assetDetailV2Enabled))
