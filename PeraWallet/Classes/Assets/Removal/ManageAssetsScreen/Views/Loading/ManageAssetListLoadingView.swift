...
//   ManageAssetListLoadingView.swift

import Foundation
import MacaroonUIKit

final class ManageAssetListLoadingView:
    View,
    ListReusable,
    ...
    init(_ theme: ManageAssetListLoadingViewTheme) {
...
extension ManageAssetListLoadingView {
...
extension ManageAssetListLoadingView {
    private func addUI(_ theme: ManageAssetListLoadingViewTheme) {
        addAssets(theme)
    }
    
    private func addAssets(_ theme: ManageAssetListLoadingViewTheme) {
        ...
        (1...theme.numberOfAssets).forEach { assetNumber in
            ...
            if assetNumber != theme.numberOfAssets {
