...
//   BackUpAccountSelectionListHeader.swift

import UIKit
import MacaroonUIKit

final class BackUpAccountSelectionListHeader:
    ...
    static let theme = BackUpAccountSelectionListHeaderTheme()
    ...
    func bindData(_ viewModel: BackUpAccountSelectionListHeaderViewModel?) {
    ...
    public static func calculatePreferredSize(
        _ viewModel: BackUpAccountSelectionListHeaderViewModel?,
