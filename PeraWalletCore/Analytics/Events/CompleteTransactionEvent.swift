...
public struct CompleteTransactionEvent: ALGAnalyticsEvent {
...
extension AnalyticsEvent where Self == CompleteTransactionEvent {
    public static func completeStandardTransaction(
    ...
    public static func completeCollectibleTransaction(
