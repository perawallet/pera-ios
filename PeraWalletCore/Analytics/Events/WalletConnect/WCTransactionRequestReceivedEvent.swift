...
//   WCTransactionRequestReceivedEvent.swift

import Foundation
import MacaroonVendors

public struct WCTransactionRequestReceivedEvent: ALGAnalyticsEvent {
...
extension AnalyticsEvent where Self == WCTransactionRequestReceivedEvent {
    public static func wcTransactionRequestReceived(
        transactionRequest: WalletConnectRequest
    ) -> Self {
