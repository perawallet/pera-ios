...
public struct LedgerAccountSelectionScreenFetchingRekeyingAccountsFailedLog: ALGAnalyticsLog {
...
extension ALGAnalyticsLog where Self == LedgerAccountSelectionScreenFetchingRekeyingAccountsFailedLog {
    public static func ledgerAccountSelectionScreenFetchingRekeyingAccountsFailed(
        accountAddress: PublicKey,
        network: ALGAPI.Network
    ) -> Self {
