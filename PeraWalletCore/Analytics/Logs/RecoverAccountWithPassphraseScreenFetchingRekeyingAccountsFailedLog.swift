...
public struct RecoverAccountWithPassphraseScreenFetchingRekeyingAccountsFailedLog: ALGAnalyticsLog {
...
extension ALGAnalyticsLog where Self == RecoverAccountWithPassphraseScreenFetchingRekeyingAccountsFailedLog {
    public static func recoverAccountWithPassphraseScreenFetchingRekeyingAccountsFailed(
        accountAddress: PublicKey,
        network: ALGAPI.Network
    ) -> Self {
