...
public final class ALGUniversalLinkConfig:
    UniversalLinkConfig,
    Decodable {
    public let qr: UniversalLinkGroupConfig
    public let walletConnect: UniversalLinkGroupConfig
    public let url: URL
...
public final class ALGUniversalLinkGroupConfig:
    UniversalLinkGroupConfig,
    Decodable {
    public let acceptedPaths: [String]
