...
public protocol UniversalLinkConfig: AnyObject {
...
extension UniversalLinkConfig {
    ...
    public func canAcceptQR(
        _ aUrl: URL
    ) -> Bool {
        containsAcceptedPaths(qr.acceptedPaths, on: aUrl)
    }

    public func canAcceptWalletConnect(
        _ aUrl: URL
    ) -> Bool {
...
public protocol UniversalLinkGroupConfig: AnyObject {
