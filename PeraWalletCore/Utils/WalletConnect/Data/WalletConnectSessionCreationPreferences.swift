...
public struct WalletConnectSessionCreationPreferences {
    public let session: WalletConnectSessionText
    public let prefersConnectionApproval: Bool
    public let isAccountMultiselectionEnabled: Bool
    public let mandotaryAccount: String?
