...
public let algorandWalletConnectV1ChainID = 4160
public let algorandWalletConnectV1MainNetChainID = 416001
public let algorandWalletConnectV1TestNetChainID = 416002

public let algorandWalletConnectV2MainNetChainReference = "wGHE2Pwdvd7S12BL5FaOP20EGYesN73k"
public let algorandWalletConnectV2TestNetChainReference = "SGO1GKSzyE7IEPItTxCByw9x8FmnrCDe"

extension WalletConnectSession {
    public func getClientMeta() -> ClientMeta {
        /// <note>
    ...
    public func getApprovedWalletConnectionInfo(for accounts: [String], on network: ALGAPI.Network) -> WalletInfo {
        return WalletInfo(
            approved: true,
            accounts: accounts,
    ...
    public func getDeclinedWalletConnectionInfo(on network: ALGAPI.Network) -> WalletInfo {
        return WalletInfo(
            approved: false,
            accounts: [],
            chainId: dAppInfo.chainId ?? chainId(for: network),
    ...
    public func toWCSession() -> WCSession {
        return WCSession(
    ...
    public func chainId(for network: ALGAPI.Network) -> Int {
        switch network {
        case .testnet:
