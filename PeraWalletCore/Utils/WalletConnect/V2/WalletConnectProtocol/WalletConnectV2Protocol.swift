...
public final class WalletConnectV2Protocol: WalletConnectProtocol {
    var eventHandler: ((WalletConnectV2Event) -> Void)?

    public private(set) var sessionValidator: WalletConnectSessionValidator = WalletConnectV2SessionValidator()
...
extension WalletConnectV2Protocol {
    public func getSessions() -> [WalletConnectV2Session] {
        return signAPI.getSessions()
    }

    public func getConnectionDates() -> [WalletConnectTopic: Date] {
    ...
    public func getPairing(for topic: String) -> Pairing? {
        return try? pairAPI.getPairing(for: topic)
    }
}

extension WalletConnectV2Protocol {
    public func connect(with preferences: WalletConnectSessionCreationPreferences) {
...
extension WalletConnectV2Protocol {
    public func isValidSession(_ uri: WalletConnectSessionText) -> Bool {
        return sessionValidator.isValidSession(uri)
    }
    
    public func configureTransactionsIfNeeded() {
        CoreAppConfiguration.shared?.wcDelegate?.startObservingPeraConnectEvents()
    }
}
...
extension WalletConnectV2Protocol {
    ...
    public func extendSession(_ session: WalletConnectV2Session) {
    ...
    public func disconnectFromSession(_ session: WalletConnectV2Session) {
    ...
    public func pingSession(_ session: WalletConnectV2Session) {
...
extension WalletConnectV2Protocol {
    public func approveTransactionRequest(
    ...
    public func rejectTransactionRequest(
        _ request: WalletConnectV2Request,
...
public enum WalletConnectV2Event {
...
public typealias SessionNamespaces = [String: SessionNamespace]
public typealias WalletConnectV2SessionNamespace = SessionNamespace
public typealias WalletConnectV2SessionProposal = WalletConnectSign.Session.Proposal
public typealias WalletConnectV2SessionRejectionReason = RejectionReason
public typealias WalletConnectV2Session = WalletConnectSign.Session
public typealias WalletConnectV2Request = WalletConnectSign.Request
public typealias WalletConnectV2CodableResult = AnyCodable
public typealias WalletConnectV2Reason = Reason
public typealias WalletConnectV2Account = WalletConnectUtils.Account
