...
public protocol WalletConnectProtocolResolver {
...
public enum WalletConnectProtocolID: String {
    case v1
    case v2
    ...
    public static func == (lhs: WalletConnectProtocolID, rhs: WalletConnectProtocolID) -> Bool {
