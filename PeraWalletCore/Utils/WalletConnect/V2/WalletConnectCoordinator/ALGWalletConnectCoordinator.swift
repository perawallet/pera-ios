...
public final class ALGWalletConnectCoordinator: WalletConnectCoordinator {
    public var eventHandler: EventHandler?
    public let walletConnectProtocolResolver: WalletConnectProtocolResolver
    
    public var v2ProtocolEventHandler: ((WalletConnectV2Event) -> Void)?
    
    public var walletConnectV1Protocol: WalletConnectV1Protocol {
        return walletConnectProtocolResolver.walletConnectV1Protocol
    }
    
    public var walletConnectV2Protocol: WalletConnectV2Protocol {
...
extension ALGWalletConnectCoordinator {
    ...
    public func isValidSession(session: WalletConnectSessionText) -> Bool {
        return
    ...
    public func getSessions() -> [WCSessionDraft] {
...
extension ALGWalletConnectCoordinator {
    public func currentProtocol(from sessionText: WalletConnectSessionText) -> WalletConnectProtocol? {
        return walletConnectProtocolResolver.getWalletConnectProtocol(from: sessionText)
    }
    
    public func currentProtocol(from params: WalletConnectParams) -> WalletConnectProtocol {
        return walletConnectProtocolResolver.getWalletConnectProtocol(from: params.currentProtocolID)
    }
    
    public func currentProtocolID() -> WalletConnectProtocolID? {
        return walletConnectProtocolResolver.currentWalletConnectProtocolID
    }
    
    public func currentProtocol(from protocolID: WalletConnectProtocolID) -> WalletConnectProtocol? {
