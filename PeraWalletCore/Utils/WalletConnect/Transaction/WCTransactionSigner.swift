...
public final class WCTransactionSigner {
    public weak var delegate: WCTransactionSignerDelegate?
    ...
    public func signTransaction(_ transaction: WCTransaction, for account: Account) {
...
extension WCTransactionSigner: LedgerTransactionOperationDelegate {
    ...
    public func ledgerTransactionOperationDidResetOperation(_ ledgerTransactionOperation: LedgerTransactionOperation) {
        delegate?.wcTransactionSignerDidResetLedgerOperation(self)
    }

    public func ledgerTransactionOperationDidResetOperationOnSuccess(_ ledgerTransactionOperation: LedgerTransactionOperation) {
        delegate?.wcTransactionSignerDidResetLedgerOperationOnSuccess(self)
    }

    public func ledgerTransactionOperationDidRejected(_ ledgerTransactionOperation: LedgerTransactionOperation) {
        delegate?.wcTransactionSignerDidRejectedLedgerOperation(self)
    }
}

extension WCTransactionSigner {
    public enum WCSignError: Error {
...
public protocol WCTransactionSignerDelegate: AnyObject {
