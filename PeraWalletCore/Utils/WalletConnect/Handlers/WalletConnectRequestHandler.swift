...
public final class WalletConnectRequestHandler: RequestHandler {
    ...
    public func canHandle(request: WalletConnectRequest) -> Bool {
        return
            request.isArbitraryDataSignRequest ||
            request.isTransactionSignRequest
    }

    public func handle(request: WalletConnectRequest) {
...
public protocol WalletConnectRequestHandlerDelegate: AnyObject {
    ...
    func startObservingPeraConnectEvents() -> Void
