...
extension Storable {
    ...
    public var keychain: KeychainAccess.Keychain {
        return KeychainAccess.Keychain(
            service: StorableKeys.storage.rawValue)
            .accessibility(.always)
    }
    
    public func save(_ string: String, for key: String, to store: Store) {
        switch store {
        case .defaults:
    ...
    public func save(_ data: Data, for key: String, to store: Store) {
        switch store {
        case .defaults:
    ...
    public func save(_ bool: Bool, for key: String, to store: Store) {
        switch store {
        case .defaults:
    ...
    public func bool(with key: String, to store: Store) -> Bool {
        switch store {
        case .defaults:
    ...
    public func object(with key: String, to store: Store) -> Object? {
        return nil
    }
    
    public func string(with key: String, to store: Store) -> String? {
        switch store {
        case .defaults:
    ...
    public func data(with key: String, to store: Store) -> Data? {
        switch store {
        case .defaults:
    ...
    public func remove(with key: String, from store: Store) {
        switch store {
        case .defaults:
    ...
    public func clear(_ store: Store) {
        switch store {
        case .defaults:
            userDefaults.clear()
        case .keychain:
