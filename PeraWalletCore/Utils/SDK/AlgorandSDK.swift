...
public class AlgorandSDK {
    
    public static let roundTreshold: Int64 = 1000
    
    public init() {
        
    }
    
    public func generatePrivateKey() -> Data? {
        return AlgoSdkGenerateSK()
    }
    
    public func sign(_ privateData: Data, with data: Data, error: inout NSError?) -> Data? {
        return AlgoSdkSignTransaction(privateData, data, &error)
    }
    
    public func getSignedTransaction(
        _ transaction: Data,
        from signature: Data,
    ...
    public func getSignedTransaction(_ transaction: Data, from signature: Data, error: inout NSError?) -> Data? {
        return AlgoSdkAttachSignature(signature, transaction, &error)
    }
    
    public func getSignedTransaction(with signer: String?, transaction: Data, from signature: Data, error: inout NSError?) -> Data? {
        return AlgoSdkAttachSignatureWithSigner(signature, transaction, signer, &error)
    }
}

extension AlgorandSDK {
    public func mnemonicFrom(_ privateKey: Data, error: inout NSError?) -> String {
        return AlgoSdkMnemonicFromPrivateKey(privateKey, &error)
    }
    
    public func privateKeyFrom(_ mnemonic: String, error: inout NSError?) -> Data? {
        return AlgoSdkMnemonicToPrivateKey(mnemonic, &error)
    }
    
    public func addressFrom(_ privateKey: Data, error: inout NSError?) -> String? {
        return AlgoSdkGenerateAddressFromSK(privateKey, &error)
    }
    
    public func addressFromPublicKey(_ publicKey: Data, error: inout NSError?) -> String {
        return AlgoSdkGenerateAddressFromPublicKey(publicKey, &error)
    }
}

extension AlgorandSDK {
    public func generateBackupPrivateKey() -> Data? {
        return AlgoSdkGenerateBackupPrivateKey()
    }

    public func generateBackupCipherKey(data: Data) -> Data? {
        return AlgoSdkGenerateBackupCipherKey("Algorand export 1.0", data)
    }

    public func backupMnemnoic(fromPrivateKey privateKey: Data, error: inout NSError?) -> String {
        return AlgoSdkBackupMnemonicFromKey(privateKey, &error)
    }

    public func backupPrivateKey(fromMnemonic mnemonic: String, error: inout NSError?) -> Data? {
        return AlgoSdkBackupMnemonicToKey(mnemonic, &error)
    }
}

extension AlgorandSDK {
    public func sendAlgos(with draft: AlgosTransactionDraft, error: inout NSError?) -> Data? {
...
extension AlgorandSDK {
    public func sendAsset(with draft: AssetTransactionDraft, error: inout NSError?) -> Data? {
    ...
    public func addAsset(with draft: AssetAdditionDraft, error: inout NSError?) -> Data? {
    ...
    public  func removeAsset(with draft: AssetRemovalDraft, error: inout NSError?) -> Data? {
        return AlgoSdkMakeAssetTransferTxn(
            getTrimmedAddress(from: draft.from),
    ...
    public func sendKeyRegTransaction(
    ...
    public func composeOptInAndSendAssetTxn(
...
extension AlgorandSDK {
    public func rekeyAccount(with draft: RekeyTransactionDraft, error: inout NSError?) -> Data? {
...
extension AlgorandSDK {
    ...
    public func signBytes(data: Data, with privateData: Data, with error: inout NSError?) -> Data? {
        return AlgoSdkSignBytes(privateData, data, &error)
    }

    public func msgpackToJSON(_ msgpack: Data?, error: inout NSError?) -> String {
        return AlgoSdkTransactionMsgpackToJson(msgpack, &error)
    }

    public func jsonToMsgpack(_ json: String, error: inout NSError?) -> Data? {
        return AlgoSdkTransactionJsonToMsgpack(json, &error)
    }

    public func findAndVerifyTransactionGroups(for transactions: [Data], error: inout NSError?) -> [Int64]? {
        return AlgoSdkFindAndVerifyTxnGroups(transactions.toSDKByteArray(), &error)?.toIntArray()
    }

    public func getTransactionID(for transaction: Data) -> String {
        return AlgoSdkGetTxID(transaction)
    }

    public func getAddressfromProgram(_ program: Data?) -> String {
        return AlgoSdkAddressFromProgram(program)
    }
    
    public func rawTransactionToSign(_ txn: Data, error: inout NSError?) -> Data? {
...
extension AlgorandSDK {
    public func composeArc59SendAssetTxn(
    ...
    public func composeArc59SendAssetTxnAndSign(
        with draft: ARC59SendAssetTransactionDraft,
        error: inout NSError?
    ) -> Data? {
        let toAddress = draft.receiver.trimmingCharacters(in: .whitespacesAndNewlines)
    ...
    public func composeArc59ClaimAssetTxn(
    ...
    public func composeArc59ClaimAssetTxnAndSign(
        with draft: ARC59ClaimAssetTransactionDraft,
        error: inout NSError?
    ) -> Data? {
    ...
    public func composeArc59RejectAssetTxn(
    ...
    public func composeArc59RejectAssetTxnAndSign(
        with draft: ARC59RejectAssetTransactionDraft,
        error: inout NSError?
    ) -> Data? {
