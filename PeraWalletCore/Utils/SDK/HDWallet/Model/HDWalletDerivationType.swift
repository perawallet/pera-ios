...
public enum HDWalletDerivationType: Codable {
    case peikert
    case bip32
    
    /// Converts to BIP32DerivationType
    public var toBIP32DerivationType: BIP32DerivationType {
        switch self {
        case .peikert:
            return .Peikert
        case .bip32:
    ...
    public static func from(_ bip32Type: BIP32DerivationType) -> HDWalletDerivationType {
        switch bip32Type {
        case .Peikert:
            return .peikert
        case .Khovratovich:
