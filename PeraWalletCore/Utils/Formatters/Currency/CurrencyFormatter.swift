...
public final class CurrencyFormatter {
    public static let shared: CurrencyFormatter = .init()

    public var formattingContext: CurrencyFormattingContext = .listItem
    public var currency: LocalCurrency?
...
public enum CurrencyConstanst {
    public static let unavailable = "N/A"
    public static let hiddenValue = "*****"
}
