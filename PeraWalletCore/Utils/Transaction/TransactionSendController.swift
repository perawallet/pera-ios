...
public final class TransactionSendController {
    public weak var delegate: TransactionSendControllerDelegate?

    public var isClosingToSameAccount: Bool {
    ...
    public var draft: SendTransactionDraft
...
public protocol TransactionSendControllerDelegate: AnyObject {
...
public enum TransactionSendControllerError {
...
public enum TransactionSendControllerAlgoError {
    case algoAddressNotSelected
    case invalidAddressSelected
    case minimumAmount
}
public enum TransactionSendControllerAssetError {
