...
public class TransactionAPIConnector {

    private var api: ALGAPI
    private let sharedDataController: SharedDataController

    public init(api: ALGAPI, sharedDataController: SharedDataController) {
        self.api = api
    ...
    public func uploadTransaction(_ signedTransaction: Data, then completion: @escaping (TransactionID?, APIError?) -> Void) {
