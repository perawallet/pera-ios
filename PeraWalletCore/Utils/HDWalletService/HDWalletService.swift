...
public final class HDWalletService: HDWalletServicing {
    ...
    public init(sdk: HDWalletSDK? = nil, derivationType: HDWalletDerivationType = .peikert) {
        self.sdk = sdk
    ...
    public static let algorandCoinType: UInt32 = 283
    public static let accountIndex: UInt32 = 0
    public static let changeIndex: UInt32 = 0
    public static let addressIndex: UInt32 = 0
    ...
    public func saveHDWalletAndComposeHDWalletAddressDetail(
        session: Session?,
    ...
    public func createAddressDetail(
    ...
    public func fastLookupAccount(address: String, api: ALGAPI) async -> AccountFastLookup? {
    ...
    public static func calculateDerivationPath(
...
public enum HDWalletError: Error, Equatable {
    case invalidEntropy
    case invalidSeed
