...
public class LedgerBLEController: NSObject {
    ...
    public weak var delegate: LedgerBLEControllerDelegate?
    
    /// Handles response from the ledger device.
    public func readIncomingData(with value: String) {
...
extension LedgerBLEController {
    ...
    public func fetchAddress(at index: Int) {
    ...
    public func verifyAddress(at index: Int) {
    ...
    public func signTransaction(_ unsignedTransactionData: Data, atLedgerAccount index: Int) {
        var packets = [Data]()
...
public protocol LedgerBLEControllerDelegate: AnyObject {
