...
public class LedgerAccountVerifyOperation: LedgerOperation, BLEConnectionManagerDelegate, LedgerBLEControllerDelegate {

    public let bleConnectionManager = BLEConnectionManager()
    public let ledgerBleController = LedgerBLEController()

    public var connectedDevice: CBPeripheral?

    public weak var delegate: LedgerAccountVerifyOperationDelegate?
    ...
    public func setLedgerDetail(_ ledgerDetail: LedgerDetail?) {
        self.ledgerDetail = ledgerDetail
    }
}

public extension LedgerAccountVerifyOperation {
    func startOperation() {
...
public protocol LedgerAccountVerifyOperationDelegate: AnyObject {
