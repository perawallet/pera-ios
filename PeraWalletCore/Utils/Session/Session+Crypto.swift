...
extension Session {
    public func mnemonics(forAccount account: String) -> [String] {
    ...
    public func privateKey(forMnemonics mnemonics: String) -> Data? {
        var error: NSError?
    ...
    public func address(for account: String) -> String? {
        guard let privateKey = privateData(for: account) else {
            return nil
        }
    ...
    public func address(fromPrivateKey privateKey: Data) -> String? {
        var error: NSError?
...
extension Session {
    ...
    /// ```
    public func makeMnemonicsBIP39(forAddress address: String) -> [String] {
        do {
