...
public class Session: Storable {
    public typealias Object = Any

    public let biometricStorageKey = "com.algorand.algorand.biometric.storage"
    public let privateStorageKey = "com.algorand.algorand.token.private"
    public let privateKey = "com.algorand.algorand.token.private.key"
    public let tempMnemonicKey = "com.algorand.algorand.token.temp.mnemonic.key"
    public let rewardsPrefenceKey = "com.algorand.algorand.rewards.preference"
    public let passwordKey = "pera.pinCode"
    /// <todo> Remove this key in other releases later when the v2 is accepted.
    public let termsAndServicesKey = "com.algorand.algorand.terms.services"
    public let termsAndServicesKeyV2 = "com.algorand.algorand.terms.services.v2"
    public let accountsQRTooltipKey = "com.algorand.algorand.accounts.qr.tooltip"
    public let notificationLatestTimestamp = "com.algorand.algorand.notification.latest.timestamp"
    public let currencyPreferenceKey = "com.algorand.algorand.currency.preference"
    public let userInterfacePrefenceKey = "com.algorand.algorand.interface.preference"
    public let announcementStateKey = "com.algorand.algorand.announcement.state"
    public let backupsKey = "com.algorand.algorand.secure.backups"
    public let backupPrivateKey = "com.algorand.algorand.secure.backup.privateKey"
    public let lastSeenNotificationIDKey = "com.algorand.algorand.lastseen.notification.id"
    public let hasBiometricAuthenticationKey = "com.algorand.algorand.biometric.authentication"
    ...
    public var preferredCurrencyID: CurrencyID {
        get {
    ...
    public var notificationLatestFetchTimestamp: TimeInterval? {
        get {
    ...
    public var lastSeenNotificationID: Int? {
        get {
...
extension Session {
    public func setAccountQRTooltipDisplayed() {
        save(true, for: accountsQRTooltipKey, to: .defaults)
    }
    
    public func isAccountQRTooltipDisplayed() -> Bool {
