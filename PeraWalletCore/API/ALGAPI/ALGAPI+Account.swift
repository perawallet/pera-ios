...
extension ALGAPI {
    ...
    @discardableResult
    public func fetchAccountFromNode(
        _ draft: AccountFetchDraft,
        queue: DispatchQueue,
        ignoreResponseOnCancelled: Bool,
    ...
    @discardableResult
    public func fetchRekeyedAccounts(
        _ account: String,
    ...
    @discardableResult
    public func fetchAccountAssetFromNode(
    ...
    @discardableResult
    public func fetchAccountFastLookup(
        _ address: String,
