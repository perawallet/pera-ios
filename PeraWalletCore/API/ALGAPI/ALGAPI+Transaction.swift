...
extension ALGAPI {
    ...
    @discardableResult
    public func trackTransaction(_ draft: TransactionTrackDraft) -> EndpointOperatable {
        return EndpointBuilder(api: self)
    ...
    @discardableResult
    public func fetchPendingTransactions(
        _ address: String,
    ...
    @discardableResult
    public func getPendingTransaction(
        _ id: TxnID,
...
extension ALGAPI {
    @discardableResult
    public func fetchASASendInboxSummary(
