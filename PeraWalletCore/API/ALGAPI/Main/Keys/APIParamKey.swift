...
public typealias APIQueryParam = ObjectQueryParam<APIParamKey>
public typealias APIBodyParam = JSONObjectBodyParam<APIParamKey>

public enum APIParamKey: String, CodingKey {
    ...
    case submittedTransactionIds = "submitted_transaction_ids"
    ...
    public static func == (lhs: APIParamKey, rhs: APIParamKey) -> Bool {
