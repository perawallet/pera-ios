...
enum ALGAPIPath: String {
    ...
    case favoritesStatus = "/devices/%@/assets/%@/favorite-status/"
    case addToFavorites = "/devices/%@/assets/%@/add-to-favorites/"
    case removeFromFavorites = "/devices/%@/assets/%@/remove-from-favorites/"
    case priceWatchStatus = "/devices/%@/assets/%@/price-watch-asset-status/"
    case addToPriceWatch = "/devices/%@/assets/%@/add-to-price-watch-assets/"
    case removeFromPriceWatch = "/devices/%@/assets/%@/remove-from-price-watch-assets/"
    ...
    case swapProviders = "/dex-swap/providers/"
    ...
    case swapUpdate = "/dex-swap/swaps/%@"
