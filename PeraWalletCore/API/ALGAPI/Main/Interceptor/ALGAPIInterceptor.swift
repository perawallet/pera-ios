...
public final class ALGAPIInterceptor: APIInterceptor {
    ...
    public func intercept(_ endpoint: EndpointOperatable) {
        setCommonHeaders(endpoint)
        setAdditionalHeaders(endpoint)
    }

    public func intercept(_ response: Response, for endpoint: EndpointOperatable) -> Bool {
        return false
    }
}
...
extension ALGAPIInterceptor {
    /// <todo>
    /// NOP!
    public var network: ALGAPI.Network {
    ...
    public func setupNetworkBase(_ network: ALGAPI.Network) -> String {
        return apiBase.setupNetworkBase(network)
    }
}

public struct APIKeyHeader: Header {
...
public struct ModificationHeader: Header {
    public let key: String
    public let value: String?
...
public struct UserAgentHeader: Header {
    public let key: String
