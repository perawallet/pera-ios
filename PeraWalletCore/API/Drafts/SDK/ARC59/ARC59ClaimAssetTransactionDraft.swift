...
public struct ARC59ClaimAssetTransactionDraft: TransactionDraft {
    var from: Account
    ...
    public init(from: Account, transactionParams: TransactionParams, inboxAccount: String?, appID: Int64, assetID: Int64, isOptedIn: Bool, isClaimingAlgo: Bool) {
        self.from = from
