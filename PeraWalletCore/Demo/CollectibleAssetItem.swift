...
public final class CollectibleAssetItem {
    public let account: Account
    public let asset: CollectibleAsset
    public let amountFormatter: CollectibleAmountFormatter
    public let showForIncomingASA: Bool?
