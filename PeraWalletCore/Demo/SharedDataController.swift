...
public protocol SharedDataController: AnyObject {
...
extension SharedDataController {
    public func sortedAccounts() -> [AccountHandle] {
...
public protocol SharedDataControllerObserver: AnyObject {
...
public enum SharedDataControllerEvent {
    case didBecomeIdle
