...
public protocol CurrencyProvider: AnyObject {
...
extension CurrencyProvider {
    public var algoValue: RemoteCurrencyValue? {
        get {
    ...
    public var fiatValue: RemoteCurrencyValue? {
        get {
            if let primaryRawCurrency = try? primaryValue?.unwrap(),
               !primaryRawCurrency.isAlgo {
                return primaryValue
...
extension CurrencyProvider {
    public func calculateExpirationDate(
