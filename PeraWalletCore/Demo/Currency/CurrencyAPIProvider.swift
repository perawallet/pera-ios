...
public final class CurrencyAPIProvider: CurrencyProvider {
    public private(set) var primaryValue: RemoteCurrencyValue?
    public private(set) var secondaryValue: RemoteCurrencyValue?
...
extension CurrencyAPIProvider {
    public func setAsPrimaryCurrency(
