...
public struct SwapAssetValueFormatter {
    public func getAssetDisplayName(
    ...
    public func getFormattedAlgoAmount(
    ...
    public func getFormattedAssetAmount(
        decimalAmount: Decimal,
        currencyFormatter: CurrencyFormatter,
