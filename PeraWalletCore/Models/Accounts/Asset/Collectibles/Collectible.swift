...
public final class Collectible: ALGEntityModel {
    public let standard: CollectibleStandard?
    public let mediaType: MediaType?
    public let thumbnailImage: URL?
    public let title: String?
    public let collection: CollectibleCollection?
    public let media: [Media]
    public let description: String?
    public let properties: [CollectibleTrait]?
...
public enum CollectibleStandard:
    RawRepresentable,
    CaseIterable,
    Codable,
    Equatable {
