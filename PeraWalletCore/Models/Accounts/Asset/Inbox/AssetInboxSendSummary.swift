...
public final class AssetInboxSendSummary: ALGEntityModel {
    public let isOptedInToProtocol: Bool
    public let minBalanceAmount: UInt64
    public let innerTransactionCount: Int
    public let totalProtocolFee: UInt64
    public let inboxAddress: String?
    public let algoFundAmount: UInt64
    public let warningMessage: AssetInboxSendSummaryWarningMessage?
