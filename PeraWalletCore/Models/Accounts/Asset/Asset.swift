...
extension Asset {
    public var isEmpty: Bool { amountWithFraction.isZero }
}

public enum AssetState: Codable {
    case ready
...
public enum AssetOperation: Codable {
    case remove
    case add
}

public struct AssetNaming {
    public let id: AssetID
    public let name: String?
    public let unitName: String?

    public var displayNames: (primaryName: String, secondaryName: String?) {
        if let name = name,
           let code = unitName,
           !name.isEmptyOrBlank,
           !code.isEmptyOrBlank {
    ...
    public var hasOnlyAssetName: Bool {
        return !name.isNilOrEmpty && unitName.isNilOrEmpty
    }

    public var hasOnlyUnitName: Bool {
        return name.isNilOrEmpty && !unitName.isNilOrEmpty
    }

    public var hasBothDisplayName: Bool {
        return !name.isNilOrEmpty && !unitName.isNilOrEmpty
    }
