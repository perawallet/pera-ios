...
public final class AssetDecoration: ALGEntityModel {
    public let id: Int64
...
public extension AssetDecoration {
...
extension AssetDecoration: Comparable {
    public static func == (lhs: AssetDecoration, rhs: AssetDecoration) -> Bool {
...
public final class AssetDecorationList:
...
extension AssetDecorationList {
    public struct APIModel:
        ...
        public var results: [AssetDecoration.APIModel]?
...
public typealias AssetID = Int64

extension AssetID {
    public var stringWithHashtag: String {
