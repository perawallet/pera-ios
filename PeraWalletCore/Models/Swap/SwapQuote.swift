...
public final class SwapQuote: ALGEntityModel {
    public static let feePadding: UInt64 = 665000 /// 0.665 Algo
    ...
    public let assetIn: AssetDecoration?
    public let assetOut: AssetDecoration?
    public let amountIn: UInt64?
    public let amountInWithSlippage: UInt64?
    public let amountInUSDValue: Decimal?
    public let amountOut: UInt64?
    public let amountOutWithSlippage: UInt64?
    public let amountOutUSDValue: Decimal?
...
extension SwapQuote {
    convenience init(
        ...
        peraFee: UInt64? = nil,
        peraFeeAmountInFeeAsset: UInt64? = nil,
        ...
        apiModel.peraFeeAmountInFeeAsset = peraFeeAmountInFeeAsset.map { String($0) }
        apiModel.peraFeeAsset = peraFeeAsset?.encode()
