...
public final class WCTransactionDetail: Codable {
    public let fee: UInt64?
    public let firstValidRound: UInt64?
    public let lastValidRound: UInt64?
    public let genesisHashData: Data?
    ...
    public private(set) var rekeyAddress: String?
   
    public let assetId: Int64?

    public let appCallArguments: [String]?
    public let appCallOnComplete: AppCallOnComplete?
    public let appCallId: Int64?
    public let appGlobalSchema: WCTransactionAppSchema?
    public let appLocalSchema: WCTransactionAppSchema?
    ...
    /// <mark> KeyReg txn
    public let votePublicKey: String?
    public let selectionPublicKey: String?
    public let stateProofPublicKey: String?
    public let voteFirstValidRound: UInt64?
    public let voteLastValidRound: UInt64?
...
extension WCTransactionDetail {
    public func transactionType(for account: Account?) -> WCTransactionType? {
    ...
    public var isAlgosTransaction: Bool {
        return type == .payment
    }

    public var isAssetTransaction: Bool {
        return type == .assetTransfer
    }

    public func isAssetAdditionTransaction(for account: Account) -> Bool {
    ...
    public func isAssetAdditionTransaction() -> Bool {
        return type == .assetTransfer && amount == 0 && sender == assetReceiver
    }

    public var isAppCallTransaction: Bool {
        return type == .applicationCall
    }

    public var isAssetConfigTransaction: Bool {
        return type == .assetConfig
    }

    public var isAssetCreationTransaction: Bool {
        return type == .assetConfig && (assetIdBeingConfigured == 0 || assetIdBeingConfigured == nil)
    }

    public var isAssetReconfigurationTransaction: Bool {
        return type == .assetConfig && assetConfigParams != nil && assetIdBeingConfigured != 0
    }

    public var isAssetDeletionTransaction: Bool {
        return type == .assetConfig && assetConfigParams == nil && assetIdBeingConfigured != 0
    }

    public var isKeyregTransaction: Bool {
        return type == .keyReg
    }

    public var hasRekeyOrCloseAddress: Bool {
        return isRekeyTransaction || isCloseTransaction
    }

    public var isRekeyTransaction: Bool {
        return rekeyAddress != nil
    }

    public var isCloseTransaction: Bool {
    ...
    public var isAppCreateTransaction: Bool {
        return isAppCallTransaction && appCallId == 0
    }

    public var validationAddresses: [String?] {
        return [
            sender,
            receiver,
            closeAddress,
...
extension WCTransactionDetail {
    public enum AppCallOnComplete: Int, Codable {
        case noOp = 0
        case optIn = 1
        case close = 2
        case clearState = 3
        ...
        public static func == (lhs: WCTransactionDetail.AppCallOnComplete, rhs: WCTransactionDetail.AppCallOnComplete) -> Bool {
...
extension WCTransactionDetail: Equatable {
    public static func == (lhs: WCTransactionDetail, rhs: WCTransactionDetail) -> Bool {
...
public final class WCTransactionAppSchema: Codable {
    public let numberOfBytes: Int?
    public let numberofInts: Int?
