...
//   RekeySuccessScreen.swift

import Foundation
import MacaroonUIKit
import UIKit

final class RekeySuccessScreen: ScrollScreen {
    ...
    private let theme: RekeySuccessScreenTheme

    init(
        sourceAccount: Account,
        theme: RekeySuccessScreenTheme = .init(),
        api: ALGAPI
    ) {
...
extension RekeySuccessScreen {
    private func bindResult() {
        let viewModel = RekeySuccessResultViewModel(sourceAccount: sourceAccount)
