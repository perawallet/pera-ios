...
//   UndoStandardAccountRekeyScreen.swift

import Foundation
import MacaroonUIKit
import UIKit

final class UndoStandardAccountRekeyScreen: ScrollScreen {
    ...
    private let theme: UndoStandardAccountRekeyScreenTheme
    ...
    init(
        ...
        theme: UndoStandardAccountRekeyScreenTheme = .init()
    ) {
...
extension UndoStandardAccountRekeyScreen {
    private func addUI() {
        addBackground()
        addTitle()
        addBody()
