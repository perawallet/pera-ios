...
//   RekeyStandardToStandardAccountConfirmationScreen.swift

import Foundation
import MacaroonUIKit
import UIKit

final class RekeyStandardToStandardAccountConfirmationScreen: ScrollScreen {
    ...
    private let theme: RekeyStandardToStandardAccountConfirmationScreenTheme
    ...
    init(
        ...
        authAccount: Account,
        theme: RekeyStandardToStandardAccountConfirmationScreenTheme = .init()
    ) {
...
extension RekeyStandardToStandardAccountConfirmationScreen {
    private func addUI() {
        addBackground()
        addTitle()
        addBody()
