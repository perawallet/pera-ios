...
//   RekeyStandardToLedgerAccountInstructionsScreenTheme.swift

import Foundation
import MacaroonUIKit
import UIKit

struct RekeyStandardToLedgerAccountInstructionsScreenTheme:
    LayoutSheet,
    StyleSheet {
    ...
    init(_ family: LayoutFamily) {
        ...
        self.illustration = [
            .image("rekey-standard-to-ledger-account-illustration"),
