...
//   RekeyedToStandardAccountInstructionsScreenTheme.swift

import Foundation
import MacaroonUIKit
import UIKit

struct RekeyedToStandardAccountInstructionsScreenTheme:
    LayoutSheet,
    StyleSheet {
    ...
    init(_ family: LayoutFamily) {
        ...
        self.illustration = [
            .image("rekeyed-to-ledger-account-illustration"),
