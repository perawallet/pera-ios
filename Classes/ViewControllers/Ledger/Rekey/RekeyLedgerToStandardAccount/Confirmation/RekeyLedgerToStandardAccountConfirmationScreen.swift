...
//   RekeyLedgerToStandardAccountConfirmationScreen.swift

import Foundation
import MacaroonUIKit
import UIKit

final class RekeyLedgerToStandardAccountConfirmationScreen: ScrollScreen {
    ...
    private let theme: RekeyLedgerToStandardAccountConfirmationScreenTheme
    ...
    init(
        ...
        authAccount: Account,
        theme: RekeyLedgerToStandardAccountConfirmationScreenTheme = .init()
    ) {
...
extension RekeyLedgerToStandardAccountConfirmationScreen {
    private func addUI() {
        addBackground()
        addTitle()
        addBody()
