...
//   RekeyLedgerToStandardAccountInstructionsScreenTheme.swift

import Foundation
import MacaroonUIKit
import UIKit

struct RekeyLedgerToStandardAccountInstructionsScreenTheme:
    LayoutSheet,
    StyleSheet {
    ...
    init(_ family: LayoutFamily) {
        ...
        self.illustration = [
            .image("rekey-ledger-to-standard-account-illustration"),
