...
//   RekeyedToLedgerAccountConfirmationScreen.swift

import Foundation
import MacaroonUIKit
import UIKit

final class RekeyedToLedgerAccountConfirmationScreen: ScrollScreen {
    ...
    private let theme: RekeyedToLedgerAccountConfirmationScreenTheme
    ...
    init(
        ...
        theme: RekeyedToLedgerAccountConfirmationScreenTheme = .init()
    ) {
...
extension RekeyedToLedgerAccountConfirmationScreen {
    private func addUI() {
        addBackground()
        addTitle()
        addBody()
