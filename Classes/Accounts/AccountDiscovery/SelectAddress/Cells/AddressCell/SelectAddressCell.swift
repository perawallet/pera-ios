...
final class SelectAddressCell:
    CollectionCell<SelectAddressListItemView>,
    ViewModelBindable  {
    var accessory: SelectAddressListItemAccessory = .unselected {
    ...
    static let theme = SelectAddressListItemTheme()
...
extension SelectAddressCell {
    ...
    private func updateAccessoryIfNeeded(old: SelectAddressListItemAccessory) {
        if accessory != old {
            updateAccessory()
