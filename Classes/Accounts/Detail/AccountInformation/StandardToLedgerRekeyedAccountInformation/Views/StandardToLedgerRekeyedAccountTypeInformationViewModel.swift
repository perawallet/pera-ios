...
//   StandardToLedgerRekeyedAccountTypeInformationViewModel.swift

import Foundation
import MacaroonUIKit

struct StandardToLedgerRekeyedAccountTypeInformationViewModel: AccountTypeInformationViewModel {
...
extension StandardToLedgerRekeyedAccountTypeInformationViewModel {
    ...
    private mutating func bindTypeIcon() {
        typeIcon = "icon-any-to-ledger-rekeyed-account".uiImage
    }

    private mutating func bindTypeTitle() {
        typeTitle =
            "title-standard-to-ledger-rekeyed"
                .localized
                .bodyMedium(lineBreakMode: .byTruncatingTail)
    }

    private mutating func bindTypeDescription() {
        let descriptionText = "standard-to-ledger-rekeyed-account-type-description".localized.footnoteRegular()
        ...
        let descriptionHighlightedText = HighlightedText(
            text: "standard-to-ledger-rekeyed-account-type-description-highlighted-text".localized,
