...
//   StandardToLedgerRekeyedAccountInformationScreen.swift
...
final class StandardToLedgerRekeyedAccountInformationScreen:
...
extension StandardToLedgerRekeyedAccountInformationScreen {
...
extension StandardToLedgerRekeyedAccountInformationScreen {
    ...
    private func bindAccountTypeInformation() {
        let viewModel = StandardToLedgerRekeyedAccountTypeInformationViewModel()
