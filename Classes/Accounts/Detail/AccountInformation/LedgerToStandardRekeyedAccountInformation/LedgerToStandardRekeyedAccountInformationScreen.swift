...
//   LedgerToStandardRekeyedAccountInformationScreen.swift
...
final class LedgerToStandardRekeyedAccountInformationScreen:
    ...
    private lazy var theme = LedgerToStandardRekeyedAccountInformationScreenTheme()
...
extension LedgerToStandardRekeyedAccountInformationScreen {
...
extension LedgerToStandardRekeyedAccountInformationScreen {
    ...
    private func bindAccountTypeInformation() {
        let viewModel = LedgerToStandardRekeyedAccountTypeInformationViewModel()
