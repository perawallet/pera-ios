...
//   LedgerToStandardRekeyedAccountTypeInformationViewModel.swift

import Foundation
import MacaroonUIKit

struct LedgerToStandardRekeyedAccountTypeInformationViewModel: AccountTypeInformationViewModel {
...
extension LedgerToStandardRekeyedAccountTypeInformationViewModel {
    ...
    private mutating func bindTypeTitle() {
        typeTitle =
            "title-ledger-to-standard-rekeyed"
                .localized
                .bodyMedium(lineBreakMode: .byTruncatingTail)
    }

    private mutating func bindTypeDescription() {
        let descriptionText = "ledger-to-standard-rekeyed-account-type-description".localized.footnoteRegular()
        ...
        let descriptionHighlightedText = HighlightedText(
            text: "ledger-to-standard-rekeyed-account-type-description-highlighted-text".localized,
