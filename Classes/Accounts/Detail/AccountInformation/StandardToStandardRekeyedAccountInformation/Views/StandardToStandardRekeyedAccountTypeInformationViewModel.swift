...
//   StandardToStandardRekeyedAccountTypeInformationViewModel.swift

import Foundation
import MacaroonUIKit

struct StandardToStandardRekeyedAccountTypeInformationViewModel: AccountTypeInformationViewModel {
...
extension StandardToStandardRekeyedAccountTypeInformationViewModel {
    ...
    private mutating func bindTypeIcon() {
        typeIcon = "icon-any-to-standard-rekeyed-account".uiImage
    }

    private mutating func bindTypeTitle() {
        typeTitle =
            "title-standard-to-standard-rekeyed"
                .localized
                .bodyMedium(lineBreakMode: .byTruncatingTail)
    }

    private mutating func bindTypeDescription() {
        let descriptionText = "standard-to-standard-rekeyed-account-type-description".localized.footnoteRegular()
        ...
        let descriptionHighlightedText = HighlightedText(
            text: "standard-to-standard-rekeyed-account-type-description-highlighted-text".localized,
