...
//   StandardToStandardRekeyedAccountInformationScreen.swift
...
final class StandardToStandardRekeyedAccountInformationScreen:
    ...
    private lazy var theme = StandardToStandardRekeyedAccountInformationScreenTheme()
...
extension StandardToStandardRekeyedAccountInformationScreen {
...
extension StandardToStandardRekeyedAccountInformationScreen {
    ...
    private func bindAccountTypeInformation() {
        let viewModel = StandardToStandardRekeyedAccountTypeInformationViewModel()
