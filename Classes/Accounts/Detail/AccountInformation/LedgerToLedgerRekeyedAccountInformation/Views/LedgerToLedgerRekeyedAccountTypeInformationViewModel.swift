...
//   LedgerToLedgerRekeyedAccountTypeInformationViewModel.swift

import Foundation
import MacaroonUIKit

struct LedgerToLedgerRekeyedAccountTypeInformationViewModel: AccountTypeInformationViewModel {
...
extension LedgerToLedgerRekeyedAccountTypeInformationViewModel {
    ...
    private mutating func bindTypeTitle() {
        typeTitle =
            "title-ledger-to-ledger-rekeyed"
                .localized
                .bodyMedium(lineBreakMode: .byTruncatingTail)
    }

    private mutating func bindTypeDescription() {
        let descriptionText = "ledger-to-ledger-rekeyed-account-type-description".localized.footnoteRegular()
        ...
        let descriptionHighlightedText = HighlightedText(
            text: "ledger-to-ledger-rekeyed-account-type-description-highlighted-text".localized,
