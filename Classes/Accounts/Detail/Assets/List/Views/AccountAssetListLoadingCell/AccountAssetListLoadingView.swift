...
//   AccountAssetListLoadingView.swift

import Foundation
import MacaroonUIKit
import UIKit

final class AccountAssetListLoadingView:
    View,
    ListReusable,
    ...
    init(_ theme: AccountAssetListLoadingViewTheme = .init()) {
...
extension AccountAssetListLoadingView {
...
extension AccountAssetListLoadingView {
    private func addUI(_ theme: AccountAssetListLoadingViewTheme) {
        addAssets(theme)
    }

    private func addAssets(_ theme: AccountAssetListLoadingViewTheme) {
