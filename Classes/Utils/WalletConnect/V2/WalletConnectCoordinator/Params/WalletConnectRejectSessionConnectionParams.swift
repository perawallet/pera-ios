...
protocol WalletConnectRejectSessionConnectionParams {
...
struct WalletConnectV2RejectSessionConnectionParams: WalletConnectRejectSessionConnectionParams {
    var proposalId: String?
    var reason: WalletConnectV2SessionRejectionReason?
}
