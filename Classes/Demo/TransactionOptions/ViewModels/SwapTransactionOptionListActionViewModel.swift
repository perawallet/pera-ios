...
//   SwapTransactionOptionListActionViewModel.swift

import MacaroonUIKit

struct SwapTransactionOptionListActionViewModel: TransactionOptionListActionViewModel {
    let icon: Image?
