...
extension QRScannerViewController: AVCaptureMetadataOutputObjectsDelegate {
    func metadataOutput(
        ...
        if let metadataObject = metadataObjects.first {
            ...
            } else if let qrBackupInformations = try? JSONDecoder().decode(QRBackupInformations.self, from: qrStringData) {
                captureSession = nil
                closeScreen()
                delegate?.qrScannerViewController(self, didRead: qrBackupInformations, completionHandler: nil)
...
protocol QRScannerViewControllerDelegate: AnyObject {
    ...
    func qrScannerViewController(_ controller: QRScannerViewController, didRead qrBackupInformations: QRBackupInformations, completionHandler: EmptyHandler?)
}
