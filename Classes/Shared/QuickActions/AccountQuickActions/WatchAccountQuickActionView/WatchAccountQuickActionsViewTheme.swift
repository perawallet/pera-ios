...
struct WatchAccountQuickActionsViewTheme:
    ...
    init(_ family: LayoutFamily) {
        ...
        self.copyAddressAction = [
            ...
            .title(Self.makeActionTitle(title: "title-copy-address".localized))
        ]
        self.showAddressAction = [
            .icon(Self.makeActionIcon(icon: "address-icon")),
            .title(Self.makeActionTitle(title: "title-show-address".localized))
        ]
        self.moreAction = [
            .icon(Self.makeActionIcon(icon: "more-icon")),
            .title(Self.makeActionTitle(title: "title-more".localized))
        ]
    }
}
