...
struct AssetDetailInfoViewTheme: StyleSheet, LayoutSheet {
    ...
    let assetIDInfoButton: ButtonStyle
    let separator: Separator

    let separatorTopPadding: LayoutMetric
    let horizontalPadding: LayoutMetric
    let yourBalanceTitleLabelTopPadding: LayoutMetric
    ...
    init(_ family: LayoutFamily) {
        ...
        self.assetIDInfoButton = [
            .icon([.normal("asset-id-info")])
        ]

        self.separatorTopPadding = -32
        self.horizontalPadding = 24
        self.yourBalanceTitleLabelTopPadding = 8
