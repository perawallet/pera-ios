...
//   AssetOptInListErrorView.swift

import Foundation
import MacaroonUIKit
import UIKit

final class AssetOptInListErrorView:
    View,
    ViewModelBindable,
    UIInteractable,
    ListReusable {
    ...
    init(_ theme: AssetOptInListErrorViewTheme = .init()) {
...
extension AssetOptInListErrorView {
    func bindData(_ viewModel: AssetOptInListErrorViewModel?) {
    ...
    static func calculatePreferredSize(
        _ viewModel: AssetOptInListErrorViewModel?,
        for theme: AssetOptInListErrorViewTheme,
...
extension AssetOptInListErrorView {
    private func addUI(_ theme: AssetOptInListErrorViewTheme) {
        addConten(theme)
    }

    private func addConten(_ theme: AssetOptInListErrorViewTheme) {
    ...
    private func addIcon(_ theme: AssetOptInListErrorViewTheme) {
    ...
    private func addTitle(_ theme: AssetOptInListErrorViewTheme) {
    ...
    private func addBody(_ theme: AssetOptInListErrorViewTheme) {
    ...
    private func addRetryAction(_ theme: AssetOptInListErrorViewTheme) {
