...
//   ReceiveCollectibleAccountViewLayout.swift

import Foundation
import MacaroonUIKit
import UIKit

final class ReceiveCollectibleAccountViewLayout: NSObject {
...
extension ReceiveCollectibleAccountViewLayout {
    func collectionView(
        ...
        case .empty:
            return insets
        case .loading:
            insets.top = 104 /// <note> Top margin to title not header.
            insets.bottom = 8
            return insets
        case .header:
            insets.top = 16
