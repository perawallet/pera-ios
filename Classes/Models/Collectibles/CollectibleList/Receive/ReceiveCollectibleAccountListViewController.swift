...
final class ReceiveCollectibleAccountListViewController:
    ...
    private lazy var listView: UICollectionView = {
        let collectionViewLayout = ReceiveCollectibleAccountViewLayout.build()
        let collectionView =
    ...
    private lazy var listLayout = ReceiveCollectibleAccountViewLayout(listDataSource: listDataSource)
