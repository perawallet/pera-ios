...
final class AlgosUSDChartViewModel: AlgorandChartViewModelConvertible {
    ...
    init(valueChangeStatus: ValueChangeStatus, values: [AlgosUSDValue], currency: Currency) {
        ...
        bindChartData(from: values, and: currency)
    }
...
extension AlgosUSDChartViewModel {
    private func bindChartData(from values: [AlgosUSDValue], and currency: Currency) {
