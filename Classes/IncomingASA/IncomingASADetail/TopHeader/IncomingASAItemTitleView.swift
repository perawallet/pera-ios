...
//   IncomingASAItemTitleView.swift

import Foundation
import MacaroonUIKit
import UIKit

final class IncomingASAItemTitleView:
    View,
    ViewModelBindable,
    ListReusable {
    ...
    func customize(
        _ theme: IncomingASAItemTitleViewTheme
    ) {
    ...
    func bindData(
        ...
        if let primaryTitle = viewModel?.primaryTitle {
            ...
            primaryTitleView.textColor = Colors.Text.mainDark.uiColor
        } else {
    ...
    class func calculatePreferredSize(
        _ viewModel: IncomingASAItemTitleViewModel?,
        for theme: IncomingASAItemTitleViewTheme,
...
extension IncomingASAItemTitleView {
