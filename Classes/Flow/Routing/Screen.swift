...
indirect enum Screen {
    ...
    case sendAlgosTransaction(algosTransactionDraft: TransactionPreviewDraft, receiver: AssetReceiverState)
    case sendAssetTransaction(assetTransactionDraft: AssetTransactionDraft, receiver: AssetReceiverState)
