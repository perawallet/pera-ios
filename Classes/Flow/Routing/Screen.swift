...
indirect enum Screen {
    ...
    case sendTransactionPreview(account: Account, receiver: AlgosReceiverState, assetDetail: AssetDetail?, isAlgoTransaction: Bool)
    case sendTransaction(transaction: TransactionPreviewDraft, receiver: AlgosReceiverState)
