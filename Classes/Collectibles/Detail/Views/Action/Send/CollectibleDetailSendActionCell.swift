...
//   CollectibleDetailSendActionCell.swift

import Foundation
import MacaroonUIKit
import UIKit

final class CollectibleDetailSendActionCell:
    ...
    static let theme = CollectibleDetailSendActionCellTheme()
    ...
    public static func calculatePreferredSize(
        for theme: CollectibleDetailSendActionCellTheme,
...
extension CollectibleDetailSendActionCell {
    enum Event {
        case performAction
    }
}
